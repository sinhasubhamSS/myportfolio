...
const ProjectCard = ({ imgUrl, title, description, gitUrl, previewUrl }) => {
    return (
        <div className="group">
            ...
            >
                {/* Overlay on Hover */}
                <div className="absolute top-0 left-0 w-full h-full hidden group-hover:flex items-center justify-center bg-[#181818]/0 group-hover:bg-[#181818]/80 transition-all duration-500">
                    <Link
                        href={gitUrl}
